...
grudsby.boot = function() {
  // Load external libraries.
  google.load('visualization', '1.0');
  google.load('jquery', '1');
  google.load('maps', '3', {'other_params': 'libraries=drawing&key=AIzaSyC6xdjB0IXsF7N04S64n_5blQOqb0dkYcU'});

  // Create the grudsby app.
  google.setOnLoadCallback(function() {
    var app = new grudsby.App();
  });
};
